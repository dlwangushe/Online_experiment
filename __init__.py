...
class Player(BasePlayer):
    ...
    Economic_status = models.IntegerField(
         choices=[[1, 'R0-R5000'], [2, 'R5000-R15000'], [3, 'R15000-R25000'], [4, 'R25000-R35000'], [5,'R35000 and above']],
    ...
    Household_belonging = models.StringField(
        label='10.Of all the groups to which members of your household belong, which two or more are important to your household?',
        widget=widgets.RadioSelect,
    )
    ...
    Small_money = models.IntegerField(
    ...
    People_village_help_other = models.StringField(
        choices=[1,'Always helping', 2,'Helping most of the time', 3,'Helping sometimes', 4,'Rarely helping', 5,'Never helping'],
    ...
    Post_office = models.IntegerField(
        choices=['Less than 15 minutes', '15-30 minutes', '31-60 minutes', 'More than one hour'],
    ...
    Nearest_working_telephone = models.StringField(
        choices=['Telephone in the house', 'Less than 15 minutes', '15-30 minutes', '31-60 minutes', 'More than 1 hour'],
